...
st.markdown("Use the widgets below to build a line bands table for your observation, or upload an existing one. "
            "Please check the  LiME documentation for more details on the [line bands model](https://lime-stable.readthedocs.io/en/latest/1_introduction/3_line_bands.html) "
...
with st.expander("Code examples", icon=":material/laptop_windows:"):
    ...
    st.caption("Filter by particle and increase the band width (in km/s)")
